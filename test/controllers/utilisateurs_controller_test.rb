...
class UtilisateursControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create utilisateur" do
    assert_difference("Utilisateur.count") do
      post utilisateurs_url, params: { utilisateur: { age: @utilisateur.age, description: @utilisateur.description, nom: @utilisateur.nom, photo: @utilisateur.photo, prenom: @utilisateur.prenom } }
    end
  ...
  test "should update utilisateur" do
    patch utilisateur_url(@utilisateur), params: { utilisateur: { age: @utilisateur.age, description: @utilisateur.description, nom: @utilisateur.nom, photo: @utilisateur.photo, prenom: @utilisateur.prenom } }
